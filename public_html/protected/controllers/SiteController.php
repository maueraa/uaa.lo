...
class SiteController extends Controller
{
    ...
    public function actionCobalt()
    {
        ...
        if ($lng==="ru")
        {
            $this->render("cobaltru");
        }
        elseif ($lng==="en")
        {
            $this->render("cobalten");
        }
        else
            $this->render('cobalt');
    }
    ...
    public function actionPhotogallery()
    {
        ...
        if ($lng==="ru")
        {
            $this->render("photogalleryru");
        }
        elseif ($lng==="en")
        {
            $this->render("photogalleryen");
        }
        else
	...
	public function actionContact()
	{
        ...
        if ($lng==="ru")
        {
            $this->render('contactru',array('model'=>$model));
        }
        elseif ($lng==="en")
        {
            $this->render('contacten',array('model'=>$model));
        }
        else
