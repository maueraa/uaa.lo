...
include_once("car_menus.php");
?>
<div class="column-center">
    <div class="custom">
        <div class="box2 block01">
            <div class="titlebox">
                <h2><?=Yii::t("strings","Спарк")?></h2>
            </div>
            <div class="text-box" align="center">
                O'z Auto Austem қўшма корхонаси Спарк автомобиллари учун турли хил кўринишлардаги дискларни ишлаб чиқаради</p>
            </div>
        </div>
        <div class="block03">
            <img src="images/spark_zag.jpg" class="fasad" width="442px" height="170">-->
        </div>
    </div>
