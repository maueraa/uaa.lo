...
<div class="column-center">
    <div class="custom">
        <div class="box block01">
            <div class="titlebox">
                <h2><?=Yii::t("strings","Ишлаб чиқариш")?></h2>
            </div>
            <div class="text-box" align="center">
                2012 йилнинг 20 сентябрида O'z Auto Austem қўшма корхонасининг очилиш маъросими бўлиб ўтди<br>&nbsp;
                <p align="right"><i><a href="?r=news/last">бу ҳақида батафсил</a><br>20.01.2013й</i></p>
            </div>
        </div>
        <div class="block03">
            <p style="font-size: 14px; padding-top: 10px">Бирор қўшимча нарса</p>
            <!--<img src="images/fasad.jpg" class="fasad" width="442px" height="170">-->
        </div>
    </div>
